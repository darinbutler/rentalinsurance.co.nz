        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 mb-8">
              How to Compare Rental Insurance in New Zealand
            </h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="prose prose-slate max-w-none">
                <p className="text-lg text-slate-700 leading-relaxed mb-6">
                  Comparing rental insurance policies doesn't have to be complicated. When evaluating different providers and their offerings, there are several key factors to consider that will directly impact how well protected your rental property and possessions are. Understanding these criteria helps you make an informed decision that aligns with your specific needs and budget.
                </p>

                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold text-slate-900 mb-2">Sum Insured</h3>
                    <p className="text-slate-700">The total value of coverage provided is fundamental to your policy. This amount should accurately reflect the replacement cost of all your possessions—furniture, electronics, clothing, and other contents. Underestimating this figure could leave you significantly underinsured if a claim occurs.</p>
                  </div>

                  <div>
                    <h3 className="text-lg font-semibold text-slate-900 mb-2">Excess Amount</h3>
                    <p className="text-slate-700">The excess is what you pay towards any claim. Higher excesses typically result in lower premiums, but ensure the amount is affordable should you need to claim. Most NZ insurers offer excess options ranging from $250 to $1,000.</p>
                  </div>

                  <div>
                    <h3 className="text-lg font-semibold text-slate-900 mb-2">Liability Limits</h3>
                    <p className="text-slate-700">Liability coverage protects you if someone is injured in your rental property and sues for damages. Compare liability limits across providers—typical coverage ranges from $1 million to $20 million. This is critical protection for renters.</p>
                  </div>

                  <div>
                    <h3 className="text-lg font-semibold text-slate-900 mb-2">Exclusions and Limitations</h3>
                    <p className="text-slate-700">Every policy has exclusions—things not covered. Common exclusions include accidental damage, gradual wear and tear, and certain high-value items. Review these carefully to understand what situations won't be covered by your policy.</p>
                  </div>

                  <div>
                    <h3 className="text-lg font-semibold text-slate-900 mb-2">Claims Process</h3>
                    <p className="text-slate-700">In your time of need, an efficient claims process matters. Check how quickly each insurer processes claims, whether they offer online claims submission, and what documentation they require. Some providers offer 24/7 claims support.</p>
                  </div>

                  <div>
                    <h3 className="text-lg font-semibold text-slate-900 mb-2">Accidental Damage Add-ons</h3>
                    <p className="text-slate-700">Standard policies typically exclude accidental damage (like breaking your TV). However, most NZ insurers offer this as a paid add-on. Consider whether this additional coverage makes sense for your lifestyle and possessions.</p>
                  </div>
                </div>
              </div>

              <div className="bg-emerald-50 rounded-lg p-8 border border-emerald-200">
                <h3 className="text-2xl font-bold text-slate-900 mb-6">Comparison Checklist</h3>
                <ul className="space-y-4">
                  <li className="flex gap-3">
                    <CheckCircle className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                    <span className="text-slate-700"><strong>Verify the sum insured</strong> covers all your belongings</span>
                  </li>
                  <li className="flex gap-3">
                    <CheckCircle className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                    <span className="text-slate-700"><strong>Compare excess amounts</strong> against premium savings</span>
                  </li>
                  <li className="flex gap-3">
                    <CheckCircle className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                    <span className="text-slate-700"><strong>Check liability coverage</strong> is sufficient for your area</span>
                  </li>
                  <li className="flex gap-3">
                    <CheckCircle className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                    <span className="text-slate-700"><strong>Review all exclusions</strong> carefully</span>
                  </li>
                  <li className="flex gap-3">
                    <CheckCircle className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                    <span className="text-slate-700"><strong>Assess claims handling</strong> processes and speed</span>
                  </li>
                  <li className="flex gap-3">
                    <CheckCircle className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                    <span className="text-slate-700"><strong>Consider add-ons</strong> like accidental damage</span>
                  </li>
                  <li className="flex gap-3">
                    <CheckCircle className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                    <span className="text-slate-700"><strong>Look at customer reviews</strong> and ratings</span>
                  </li>
                  <li className="flex gap-3">
                    <CheckCircle className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                    <span className="text-slate-700"><strong>Compare discounts available</strong> (multi-policy, loyalty, safety)</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          {/* What Makes a Good Policy Section */}
          <div className="mb-16 bg-slate-50 rounded-lg p-8 lg:p-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 mb-8">
              What Makes a Good Rental Insurance Policy?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white rounded-lg p-6 border border-slate-200">
                <h3 className="text-lg font-semibold text-slate-900 mb-3">Comprehensive Coverage</h3>
                <p className="text-slate-700">A quality policy covers not just your contents, but also provides liability protection, legal liability, and optional accidental damage coverage. Look for insurers who make it easy to customize coverage to your needs.</p>
              </div>

              <div className="bg-white rounded-lg p-6 border border-slate-200">
                <h3 className="text-lg font-semibold text-slate-900 mb-3">Transparent Pricing</h3>
                <p className="text-slate-700">The best policies have no hidden fees or surprise charges. Premiums should be competitive, and any extras or add-ons should be clearly itemized. Discounts should be easy to access and understand.</p>
              </div>

              <div className="bg-white rounded-lg p-6 border border-slate-200">
                <h3 className="text-lg font-semibold text-slate-900 mb-3">Fast Claims Settlement</h3>
                <p className="text-slate-700">When you need to claim, a good insurer processes your claim quickly and fairly. They should have a dedicated claims team, multiple ways to submit claims, and clear timelines for assessment and payment.</p>
              </div>

              <div className="bg-white rounded-lg p-6 border border-slate-200">
                <h3 className="text-lg font-semibold text-slate-900 mb-3">Excellent Customer Service</h3>
                <p className="text-slate-700">Responsive support is essential. Quality insurers offer multiple contact channels (phone, email, online chat), answer questions promptly, and have high customer satisfaction ratings. Read reviews before choosing.</p>
              </div>

              <div className="bg-white rounded-lg p-6 border border-slate-200">
                <h3 className="text-lg font-semibold text-slate-900 mb-3">Flexible Payment Options</h3>
                <p className="text-slate-700">Leading providers offer both annual and monthly payment options without excessive surcharges. Some offer discounts for annual payment, making it easier to manage your budget.</p>
              </div>

              <div className="bg-white rounded-lg p-6 border border-slate-200">
                <h3 className="text-lg font-semibold text-slate-900 mb-3">Clear Policy Documents</h3>
                <p className="text-slate-700">Don't overlook the importance of understandable policy wording. A good insurer explains what's covered and what isn't in plain English, not jargon-filled legal language.</p>
              </div>
            </div>
          </div>
